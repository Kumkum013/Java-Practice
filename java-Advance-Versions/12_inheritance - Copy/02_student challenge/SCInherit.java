...
public class SCInherit 
{
    ...
    {
        // Example usage:
        SavingsAccount sa = new SavingsAccount("123", "John Doe", "123 Main St", "1234567890", "01-01-1990");
        sa.deposit(1000);
        sa.withdraw(200);
        System.out.println("Savings Account Balance: " + sa.getBalance());

        LoanAccount la = new LoanAccount("456", "Jane Smith", "456 Elm St", "0987654321", "02-02-1985");
        la.payEMI(500);
        la.repay(0);
